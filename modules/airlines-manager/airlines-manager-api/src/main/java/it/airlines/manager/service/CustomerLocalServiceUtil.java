 ...
 * <code>it.airlines.manager.service.impl.CustomerLocalServiceImpl</code> and
...
public class CustomerLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.airlines.manager.service.impl.CustomerLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static it.airlines.manager.model.Customer addCustomer(
		it.airlines.manager.model.Customer customer) {
	 ...
	 */
	public static it.airlines.manager.model.Customer createCustomer(
		long customerId) {
	 ...
	 */
	public static it.airlines.manager.model.Customer deleteCustomer(
		it.airlines.manager.model.Customer customer) {
	...
	public static it.airlines.manager.model.Customer fetchCustomer(
		long customerId) {
	 ...
	 */
	public static it.airlines.manager.model.Customer
	 ...
	 * @throws PortalException if a customer with the primary key could not be found
	 */
	public static it.airlines.manager.model.Customer getCustomer(
			long customerId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static it.airlines.manager.model.Customer
			getCustomerByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<it.airlines.manager.model.Customer>
	...
	public static java.util.List<it.airlines.manager.model.Customer>
		getCustomersByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<it.airlines.manager.model.Customer> orderByComparator) {
	 ...
	 */
	public static it.airlines.manager.model.Customer updateCustomer(
		it.airlines.manager.model.Customer customer) {
