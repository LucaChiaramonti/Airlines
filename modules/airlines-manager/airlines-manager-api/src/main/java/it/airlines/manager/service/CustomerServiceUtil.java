 ...
 * <code>it.airlines.manager.service.impl.CustomerServiceImpl</code> and is an
...
public class CustomerServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.airlines.manager.service.impl.CustomerServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
