...
public interface CustomerLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomerLocalServiceUtil} to access the customer local service. Add custom service methods to <code>it.airlines.manager.service.impl.CustomerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
