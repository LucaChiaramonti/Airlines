...
public class CustomerLocalServiceWrapper
	 ...
	 */
	@Override
	public it.airlines.manager.model.Customer addCustomer(
	 ...
	 */
	@Override
	public it.airlines.manager.model.Customer createCustomer(long customerId) {
	 ...
	 */
	@Override
	public it.airlines.manager.model.Customer deleteCustomer(
		it.airlines.manager.model.Customer customer) {
	 ...
	 */
	@Override
	public it.airlines.manager.model.Customer deleteCustomer(long customerId)
	...
	@Override
	public it.airlines.manager.model.Customer fetchCustomer(long customerId) {
	 ...
	 */
	@Override
	public it.airlines.manager.model.Customer fetchCustomerByUuidAndGroupId(
	 ...
	 */
	@Override
	public it.airlines.manager.model.Customer getCustomer(long customerId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public it.airlines.manager.model.Customer getCustomerByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<it.airlines.manager.model.Customer> getCustomers(
		int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<it.airlines.manager.model.Customer>
	 ...
	 */
	@Override
	public it.airlines.manager.model.Customer updateCustomer(
		it.airlines.manager.model.Customer customer) {
